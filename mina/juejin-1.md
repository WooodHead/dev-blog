...
[开发 “小程序” 必备书单](http://mp.weixin.qq.com/s?__biz=MjM5Njc0MjIwMA==&mid=2649639814&idx=1&sn=139fa454d496a1bfc37e9f4786b8fe54&mpshare=1&scene=1&srcid=1003zbJWEJ4NjY5saqgj5Yzn#rd) ⭑389
...
在该品台注册账号获取AppId，使用AppId登入微信开发者工具，开启项目 使用的API文档: 微信小程序开发文档, 微信小程序开发教程手册文档\_w3c详细介绍了微信各种工具的使用 Vant Weapp,提供了好多实用性的组件
...
[两小时快速构建微信小程序](https://juejin.im/post/5ae7b96f6fb9a07aa6318df1) ⭑284
...
[前端错误收集（Vue.js、微信小程序）](https://juejin.im/post/5c0f19dff265da61461e0140) ⭑182
...
[一起脱去小程序的外套 - 微信小程序架构解析](http://mp.weixin.qq.com/s/3QE3g0NmaBAi91lbrihhVw) ⭑53
...
[微信小程序适配 iPhone X 总结](https://juejin.im/post/5b595e616fb9a04f9e231ad1) ⭑74
...
[小程序之豆瓣电影源码解读](https://juejin.im/post/588181ac1b69e60058cdf91b) ⭑132
...
[微信小程序 - 知乎日报](https://github.com/myronliu347/wechat-app-zhihudaily) ⭑52

微信小程序版的知乎日报，现在实现的比较简陋，以后随着小程序的完善，我也会完善这个项目

[记一次小程序项目的开发心得](https://juejin.im/post/5b32ec1d51882574a11f7085) ⭑85

前言：这段时间一直负责公司的小程序的开发，总结了一些小程序的开发心得，方便自己以后的查阅也方便同仁少踩点坑。文章底部的技巧类小程序的识别小程序二维码功能，小程序的高斯模糊，都是自己填的坑。欢迎交流。 一

[小程序异常监控收集](https://juejin.im/post/5b1794f16fb9a01e2a0e4b01) ⭑53
...
[wemark - 微信小程序 Markdown 渲染库](https://github.com/TooBug/wemark) ⭑44
...
[微信小程序组件化的解决方案](http://leanote.com/blog/post/5a5dad39ab64412da30022e6) ⭑68
...
[微信小程序 TypeScript 尝试](https://juejin.im/post/5c5c2ef3e51d450aab0a2a85) ⭑44
...
[小程序优化实践](https://juejin.im/post/5bff4c24e51d452cce6bfe5e) ⭑42

采用的目录是下面这样子的，我们直接用下面的目录在小程序上运行，上传预览。 后来我们发现，小程序其实很傻很天真，它把该目录的所有文件都一股脑上传上去，也就是用户要使用这个小程序，它也需要额外下载 config 文件夹

[写给 Android 开发的小程序布局指南，Flex 布局！](https://juejin.im/post/5b1fb5ea5188257d6b5d0b9e) ⭑115
...
[小程序实战总结](https://mp.weixin.qq.com/s?__biz=MzUxMDYxNTgwMA==&mid=2247484084&idx=1&sn=b9e568e9b10dc60106a8e2e5144a6711&chksm=f9010b23ce7682355b1d4bd7844fd4ade11d7267ae46ecfd2045b0e761001d52348f1c06ce38&token=581748138&lang=zh_CN#rd) ⭑39

假如用户已经打开过某小程序，然后在一定时间内再次打开该小程序，此时无需重新启动，只需将后台态的小程序切换到前台，这个过程就是热启动；冷启动指的是用户首次打开或小程序被微信主动销毁后再次打开的情况，此时小程序需要重新加载启动

[一种让小程序支持JSX语法的新思路](https://juejin.im/post/5d059cad5188257a78764d86) ⭑59

React社区一直在探寻使用React语法开发小程序的方式，其中比较著名的项目有Taro，nanachi。而使用React语法开发小程序的难点主要就是在JSX语法上，JSX本质上是JS，相比于小程序静态模版来说太灵活。本文

[微信小程序 \| 49，小程序入门集锦系列文章20篇](https://juejin.im/post/59d5932f6fb9a00a496e908c) ⭑26

微信小程序开发初学常见基础问题 【小程序入门集锦】11，仿某宝顶部可滑动Tab效果 【小程序入门集锦】12，一个可爱的互动登陆面板 【小程序入门集锦】13， 小程序开放长按二维码打开功能及使用小程序开发的微信源码（包括前端后端）

[微信小程序性能优化方案——让你的小程序如此丝滑](https://juejin.im/post/5bdbc28e51882516eb55dd1d) ⭑228

这步是微信做的。微信会在用户打开小程序之前就已经准备好环境，用户点击小程序入口后，直接下载小程序的代码包即可。 下载代码包启动小程序 小程序代码包里面的代码，不是小程序的源代码，而是编译、压缩、打包之后的代码包

[小程序“圣诞帽”的实现思路](https://juejin.im/post/5a4104f5f265da43052edd22) ⭑46

把头像画在Canvas里面，接着往Canvas里画帽子，调整帽子的参数（位置、大小、旋转），最后保存为图片。 先来看看效果（文章底部有小程序码，扫一扫体验） 思路 1.获取用户头像 这里有个问题需要注意，canvas不支持网络图片

[微信小程序授权登录最佳实践](https://juejin.im/post/5b549536e51d451a244bd863) ⭑59

公司业务开展，最近完成了一个微信小程序的开发。场景是这样：同一微信开放平台下拥有相同主体的APP和微信小程序来完成同样的业务，用户进入app或者微信小程序时必须获取用户的unionid来确认当前的用户身份

[WeZRender：微信小程序 Canvas 增强组件](https://github.com/guyoung/WeZRender) ⭑41

WeZRender是一个微信小程序Canvas增强组件，基于HTML5 Canvas类库ZRender。 使用 WXML： JS： 特性 数据驱动 利用WeZRender绘图，只需定义图形数据。 丰富的图形选项

[微信小程序 2048 开发记录](http://blog.shanamaid.top/2017/02/06/%E5%BE%AE%E4%BF%A1%E5%B0%8F%E7%A8%8B%E5%BA%8F2048%E5%BC%80%E5%8F%91%E8%AE%B0%E5%BD%95/) ⭑41

主体功能已经基本实现，还有一些细节地方待优化。 对于微信小程序的介绍 1 微信小程序结构分析 每个页面的基本构成依然是html、css、js，但是格式后缀上有些许变换，html与js不变，但是css=&gt;wxss。同时每个项目都有三个关键的文件

[微信小程序开发初体验 -- 教你开发小程序](http://www.jianshu.com/p/7a94a6b6be96) ⭑87

我们先确定想要开发一款什么样的小程序，首先要符合「小」，因为我们这次是要体验小程序的开发，所以尽量不要弄得太复杂；其次是「快」，小程序里需要的数据啊、资源啊，最好是现成就有的，自己写个API什么的这就太耗时了

[微信小程序之手势解锁](http://jsh5css.cn/blog/%E5%BE%AE%E4%BF%A1%E5%B0%8F%E7%A8%8B%E5%BA%8F%E4%B9%8B%E6%89%8B%E5%8A%BF%E8%A7%A3%E9%94%81/) ⭑40

微信小程序版手势解锁，也是在前辈们的基础上做的改版，可以称作是仿的轮子吧 效果图： 1、首先进行页面布局，wxml文件代码： 这里需要对解锁提示语，解锁提示语颜色

[微信小程序登录页动画-云层漂浮](https://juejin.im/post/590aacbea22b9d0057a41f45) ⭑59

2017年前端火了，微信小程序、weex、reactnative，就连支付宝也搞起了小程序，总感觉这是原生要毁灭的节奏啊，我也乘热上车万一波。 上效果图\(GI动态图\) 微信小程序动画 当我看到这张背景图的时候

[微信小程序卡券开发分享](http://www.wxapp-union.com/forum.php?mod=viewthread&tid=4852) ⭑42

4840&extra=page%3D1 想请教下 小程序卡券开发事宜，无奈设计卡券开发的实战太少，我就自己研究了下，现在分享下自己的代码~~~ 一 、 开发小程序卡券的前提是： 1、小程序和公众号有绑定 2、小程序和该公众号需要绑定

[数组操作 - 微信小程序学习教程](http://lanchenglv.com/article/2016/1113/wxapp_array_concat_splice.html) ⭑58

com/bluefox1688/wxapp\_study 交流 最近大家对微信小程序开发热情大涨，结识了不少对微信小程序技术开发的牛人，也有一些刚入行的新手，特此我建立了一个微信小程序技术交流圈子，希望给大伙有一个纯洁的技术交流圈子

[\[贝聊科技\]在微信小程序中渲染HTML内容](https://juejin.im/post/5b9b2be55188255c9a771e79) ⭑60

通过HTML文档去展示HTML内容自然没有问题。但是，在微信小程序（下文简称为「小程序」）中，应当如何渲染这部分内容呢？ 解决方案 wxParse 小程序刚上线那会儿，是无法直接渲染HTML内容的，于是就诞生了一个叫做「wxParse」的库

[健壮高效的小程序登录方案](https://mp.weixin.qq.com/s?__biz=MzU0OTExNzYwNg==&mid=2247484421&idx=1&sn=a40c6ca294de39fe502a8d511994da34&chksm=fbb58fccccc206dae8b559365706a8b60f6ce654b46b0414b1a04c7481502d3838c030450dc3&token=1355569705&lang=zh_CN&rd2werd=1#wechat_redirect) ⭑63

加入免并发逻辑：若登录流程正在进行，则不重复触发登录流程，而是加入当前流程的监听队列，待登录结束时再一并处理。这样，任一时刻最多只有一个登录流程正在进行。 流程实现 时序控制 如上图所示，目前登录流程已较为复杂，步骤较多

[微信小程序--蓝牙连接开发总结](http://www.jianshu.com/p/0b41d9ff7abc) ⭑59
...
[必看！官方文档没有！从零接入小程序支付](http://www.wxapp-union.com/portal.php?mod=view&aid=375) ⭑113

开发者首先需要大概了解这些接口 小程序公众号支付的主要流程如下（本图只考虑了正常流程，异常流程参考公众号支付文档）： 3.1 关于openid 上述流程中请求openid，用的是小程序最新api中的接口，开发者可以查看小程序的登录接口

[给 ofo 共享单车撸一个微信小程序｜附源代码，原文已拆分更新](http://www.jianshu.com/p/3f9b78c68887) ⭑299
...
[世界杯来了！小程序赛事操作来一波~](https://juejin.im/post/5b22f71fe51d4558ab7b16d4) ⭑88
...
[微信小程序踩坑指南](https://juejin.im/post/5cf0d56ef265da1bd3054036) ⭑32

参考文章: 微信小程序之scroll-view的flex布局问题 小程序开发中的那些小坑 微信公众号/小程序开发配置常见错误信息 小程序里的登录态处理，主要参考以下文章\(具体实现省略\): 健壮高效的小程序登录方案

[微信「小程序」，一个有局限的类似 React Native 轮子！](http://www.jianshu.com/p/060c6f3dd4e8) ⭑74

先抛出结论：微信小程序就是一个类似RN的轮子，可以快速开发，有一定的适用场景，但是也有其局限性。 本文针对微信小程序的示例代码进行分析，告诉大家：微信小程序到底提供了什么？开发微信小程序方便么？微信小程序具体适用场景

[微信小程序转盘抽奖](https://github.com/givebest/wechat-turntalbe-canvas) ⭑29

简介 用微信小程序开发的Canvas绘制可配置的转盘抽奖。 使用[https://github.com/givebest/GB-canvas-turntable代码移植过而来。](https://github.com/givebest/GB-canvas-turntable代码移植过而来。) 其它 微信小程序感觉是个半成品

[微信小程序支付功能全流程实践](https://juejin.im/post/5d37e832e51d45106172119c) ⭑41

前言 微信小程序为电商类小程序，提供了非常完善、优秀、安全的支付功能。在小程序内可调用微信的API完成支付功能，方便、快捷。小程序开发者在开发小程序时，支付流程是必然要接触到，今天胡哥就小程序支付的全流程为大家一一细说

[微信小程序登录方式的修改解决方案](https://juejin.im/post/5b0e4ed2518825154a472f08) ⭑78

微信小程序官方登录方式修改，要求通过button点击登录，和大家分享一下我的解决方案。 原先的登录逻辑是注册一个全局login方法， login方法中首先调用wx.login静默登录，获取临时登录凭证code

[微信小程序敏感内容检测](https://www.kelen.cc/posts/5ae5ee73a05e8575d614cb0c) ⭑30

grant\_type 是 此处为client\_credential appid 是 小程序的appid secret 是 小程序的appsecret 正常返回结果 其他具体信息查看文档 敏感文本检测 这是接口基于https协议

[Taro小程序仿网易云音乐](https://juejin.im/post/5c734354e51d450b8f46968a) ⭑30
...
[微信小程序onLaunch异步，首页 onLoad 先执行 ?](https://www.jianshu.com/p/aaf65625fc9d) ⭑45
